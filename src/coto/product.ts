...
const extractName = async (page: Page) =>
  await extractFromElement(page, 'h1.product_page', elementText)

const extractPrice = async (page: Page) => {
...
const extractCategories = async (page: Page) => {
...
export const scrapProduct = async (browser: Browser, url: string, market: Market) => {
